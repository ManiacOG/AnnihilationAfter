...
import net.mcreator.annimath.item.CronItem;
...
public class CronPlantBlock extends AnnimathModElements.ModElement {
	@ObjectHolder("annimath:cron_plant")
	public static final Block block = null;
	public CronPlantBlock(AnnimathModElements instance) {
		super(instance, 35);
	}
	...
	public static class BlockCustomFlower extends SugarCaneBlock {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(CronItem.block, (int) (1)));
		}
