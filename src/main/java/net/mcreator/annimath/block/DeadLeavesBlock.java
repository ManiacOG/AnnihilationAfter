...
public class DeadLeavesBlock extends AnnimathModElements.ModElement {
	@ObjectHolder("annimath:dead_leaves")
	public static final Block block = null;
	public DeadLeavesBlock(AnnimathModElements instance) {
		super(instance, 24);
	}
