...
import net.mcreator.annimath.gui.InfuserGUIGui;
...
public class InfuserBlock extends AnnimathModElements.ModElement {
	@ObjectHolder("annimath:infuser")
	public static final Block block = null;
	@ObjectHolder("annimath:infuser")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public InfuserBlock(AnnimathModElements instance) {
		super(instance, 51);
