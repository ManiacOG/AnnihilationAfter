...
public class AmethystArmorItem extends AnnimathModElements.ModElement {
	@ObjectHolder("annimath:amethyst_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("annimath:amethyst_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("annimath:amethyst_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("annimath:amethyst_armor_boots")
	public static final Item boots = null;
	public AmethystArmorItem(AnnimathModElements instance) {
		super(instance, 77);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(AftermathItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "annimath:textures/models/armor/amethyst_layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
