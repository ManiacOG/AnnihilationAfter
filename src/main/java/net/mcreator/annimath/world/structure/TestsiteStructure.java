...
public class TestsiteStructure extends AnnimathModElements.ModElement {

	public TestsiteStructure(AnnimathModElements instance) {
		super(instance, 21);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 1000) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) world.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("annimath", "testsite"));
